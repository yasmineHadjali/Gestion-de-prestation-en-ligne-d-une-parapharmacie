 ...
 foreach($result as $row)
 {
  $output .= '
   <table width="100%" border="1" cellpadding="5" cellspacing="0">
    <tr>
     <td colspan="2" align="center" style="font-size:18px"><b>BON DE COMMANDE</b></td>
    </tr>
    <tr>
     <td colspan="2">
      ...
      <tr>
      <td>
      <div width="250" height="60">
      <img src="logoInv.png" alt="">
      </div>
      <div style="margin-top : 10px;">Boulevard Krim Belkacem</div>
      <div>Tizi Ouzou , 15000</div>
      <div style="margin-bottom : 50px;">(+213)555-472356</div>
      </td>
      ...
      <tr>
        ...
        <b>À</b>,<br />
         ...
         Nom : '.$row["order_receiver_name"].'<br /> 
         Adresse du destinataire : '.$row["order_receiver_address"].'<br />
        </td>
        <td width="35%">
        Charge inverse<br />
         N ° : '.$row["order_no"].'<br />
        Date commande : '.$row["order_date"].'<br />
        </td>
       </tr>
      </table>
      <br />
