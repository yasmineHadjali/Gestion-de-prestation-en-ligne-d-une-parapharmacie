$(document).ready(function() {
    ...
    tablaUsuarios = $('#tablaUsuarios').DataTable({
        ...
        "columns": [
            ...
            { "data": "telephone" },
            // {"data": "status"},
            { "defaultContent": "<div class='text-center'><div class='btn-group'> <button class='btn btn-primary btn-sm btnEditar'><i class='material-icons'>edit</i></button><button class='btn btn-danger btn-sm btnBorrar'><i class='material-icons'>delete</i></div></div>", "orderable": false }
        ]
    });
    ...
    $(document).on("click", ".userinfo", function() {
        ...
        $("#nom1").html(nom);
        $("#email1").html(email);
        $("#civilite1").html(civilite);
        $("#telephone1").html(telephone);
