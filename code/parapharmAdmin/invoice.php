...
if(isset($_GET['add'])){
    ...
    <textarea name="order_receiver_address" id="order_receiver_address" cols="30" rows="10" class="form-control" placeholder="Enter Billing Address"></textarea>
    </div>
    <div class="col-md-4">
    Reverse Charge <br>
    ...
    <td><input type="text" name="order_item_quantity[]" id="order_item_quantity1" date-srno="1" class="form-control input-sm order_item_quantity"></td>
    <td><input type="text" name="order_item_price[]" id="order_item_price1" date-srno="1" class="form-control input-sm number_only order_item_price"></td>
    <td><input type="text" name="order_item_actual_amount[]" id="order_item_actual_amount1" date-srno="1" class="form-control input-sm order_item_actual_amount" readonly></td>
    <td><input type="text" name="order_item_tax1_rate[]" id="order_item_tax1_rate1" date-srno="1" class="form-control input-sm number_only order_item_tax1_rate"></td>
    <td><input type="text" name="order_item_tax1_amount[]" id="order_item_tax1_amount1" date-srno="1" readonly class="form-control input-sm  order_item_tax1_amount"></td>
    <td><input type="text" name="order_item_tax2_rate[]" id="order_item_tax2_rate1" date-srno="1" class="form-control input-sm number_only order_item_tax2_rate"></td>
    <td><input type="text" name="order_item_tax2_amount[]" id="order_item_tax2_amount1" date-srno="1" readonly class="form-control input-sm  order_item_tax2_amount"></td>
    <td><input type="text" name="order_item_tax3_rate[]" id="order_item_tax3_rate1" date-srno="1" class="form-control input-sm number_only order_item_tax3_rate"></td>
    <td><input type="text" name="order_item_tax3_amount[]" id="order_item_tax3_amount1" date-srno="1" readonly class="form-control input-sm  order_item_tax3_amount"></td>
    <td>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','#add_row',function(){
            ...
            // html_code += '<td><input type="text" name="order_item_quantity[]" id="order_item_quantity'+count+'" date-srno="'+count+'" class="form-control input-sm number_only order_item_quantity"></td>';
            html_code += '<td><input type="text" name="order_item_price[]" id="order_item_price'+count+'" date-srno="'+count+'" class="form-control input-sm number_only order_item_price"></td>';
            html_code += '<td><input type="text" name="order_item_actual_amount[]" id="order_item_actual_amount'+count+'" date-srno="'+count+'" class="form-control input-sm number_only order_item_actual_amount " readonly></td>';
            html_code += '<td><input type="text" name="order_item_tax1_rate[]" id="order_item_tax1_rate'+count+'" date-srno="'+count+'" class="form-control input-sm number_only order_item_tax1_rate "></td>';
        
            html_code += '<td><input type="text" name="order_item_tax1_amount[]" id="order_item_tax1_amount'+count+'" date-srno="'+count+'" readonly class="form-control input-sm number_only order_item_tax1_amount "></td>';
            
            html_code += '<td><input type="text" name="order_item_tax2_rate[]" id="order_item_tax2_rate'+count+'" date-srno="'+count+'" class="form-control input-sm number_only order_item_tax2_rate "></td>';

            html_code += '<td><input type="text" name="order_item_tax2_amount[]" id="order_item_tax2_amount'+count+'" date-srno="'+count+'" readonly class="form-control input-sm number_only order_item_tax2_amount "></td>';

            html_code += '<td><input type="text" name="order_item_tax3_rate[]" id="order_item_tax3_rate'+count+'" date-srno="'+count+'" class="form-control input-sm number_only order_item_tax3_rate "></td>';

            
            html_code += '<td><input type="text" name="order_item_tax3_amount[]" id="order_item_tax3_amount'+count+'" date-srno="'+count+'" readonly class="form-control input-sm number_only order_item_tax3_amount "></td>';

            html_code += '<td><input type="text" name="order_item_final_amount[]" id="order_item_final_amount'+count+'" date-srno="'+count+'" readonly class="form-control input-sm  order_item_final_amount "></td>';
...
<div >
<a href="invoice.php?add=1" class="btn btn-info btn-lg">Create</a>
</div>
...
<div class="container-fluid">
 ...
 <!-- <h1 class="h3 mb-2 text-gray-800">Clients</h1> -->
            ...
            <h6 class="m-0 font-weight-bold text-primary"> Datatable Commande</h6>
        </div>
<div class="card-body">
  <div class="table-responsive">
