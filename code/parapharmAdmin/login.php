            ...
            <!-- <div class="row"> -->
              ...
              <div class="col-lg-10">
                <div class="p-5">
                  ...
                  ?>
                  <form class="user" method="get" action="code.php">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name = "email" placeholder="Entrer l'adresse e-mail...">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit"  name="login_btn" class="btn btn-info btn-user btn-block">
                      S'identifier
                    </button>
