...
if(isset($_POST['modifier'])){
    ...
    $Client_nom=$_POST['Client_nom'];
     ...
     if($newnom == $Client_nom){
        $pres = $base->prepare("UPDATE clients SET Client_nom='$Client_nom'    WHERE   email='$email'  ");
	 ...
	 }else  echo '<script type ="text/javascript"> alert("les 2 noms sont differents") </script>';  
    ...
    <div class="container-fluid main-container">
                                ...
                                <nav class="navbar navbar-default" role="navigation" style="background-color:#97C6FB">
                                    ...
                                    <div class="side-menu-container">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="modifnom.php"><span><i class="glyphicon glyphicon-cog"></i></span> Modifier le nom</a></li>
        ...
        <div class="col-md-10 content">
            <div class="panel panel-default" >
                ...
                <p style="font-size:20px; font-family:'Gothic A1';"> Modifier le nom </p>
                </div>
                <div class="panel-body" >
                    <div class="row">  
                    <div class="col-md-6 col-md-offset-3">
                            <form class="well form-horizontal" action="" method="post" style="background-color:white;" >
                                
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="Client_nom">email</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="Client_nom">nouveau nom</label>
                                        <input id="newnom" name="newnom" class="form-control" type="text" required>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="Client_nom">confirmer le nouveau nom</label>
                                        <input id="Client_nom" name="Client_nom" type="text" class="form-control" >  
                                    </div>
                                </div>
