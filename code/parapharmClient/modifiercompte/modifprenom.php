...
if(isset($_POST['modifier'])){
    ...
    $Client_prenom=$_POST['Client_prenom'];
     ...
     if($newprenom == $Client_prenom){
        $pres = $base->prepare("UPDATE clients SET Client_prenom='$Client_prenom'    WHERE   email='$email'  ");
	 ...
	 }else  echo '<script type ="text/javascript"> alert("les 2 prénoms sont differents") </script>';  
    ...
    <div class="container-fluid main-container" >
                                ...
                                <nav class="navbar navbar-default" role="navigation" style="background-color:#97C6FB">
                                    ...
                                    <div class="side-menu-container">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="modifprenom.php"><span><i class="glyphicon glyphicon-cog"></i></span> Modifier prénom</a></li>
        ...
        <div class="col-md-10 content">
            <div class="panel panel-default" >
                ...
                <p style="font-size:20px; font-family:'Gothic A1';"> Modifier le prénom</p>
                </div>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                            <form class="well form-horizontal" action="" method="post" style="background-color:#F5F5F5;" >
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="Client_prenom">email</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="Client_prenom">nouveau prénom</label>
                                        <input id="newprenom" name="newprenom" class="form-control" type="text" required>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="Client_prenom">confirmer le nouveau prénom</label>
                                        <input id="Client_prenom" name="Client_prenom" type="text" class="form-control" >  
                                    </div>
                                </div>
      ...
      <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        <div class="footer__copyright__text"><p>Parapharmacie en lign 2020-2021</p></div>
