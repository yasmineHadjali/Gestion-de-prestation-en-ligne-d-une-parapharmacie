...
if(isset($_POST['modifier'])){
 ...
 /* $pdostat=$base->prepare('SELECT email  FROM clients WHERE email="$email" ');
       //execution requete
    ...
    <div class="container-fluid main-container">
                                ...
                                <nav class="navbar navbar-default" role="navigation" style="background-color:#97C6FB">
                                    ...
                                    <div class="side-menu-container">
                                        <ul class="nav navbar-nav">
                                            <!-- ajouter 1 -->
                                              <li class="active"><a href="modifmdp.php"><span><i class="glyphicon glyphicon-cog"></i></span> Modifier le mot de passe</a></li>
        ...
        <div class="col-md-10 content">
            <div class="panel panel-default" >
                ...
                <p style="font-size:20px; font-family:'Gothic A1';"> modifier mot de passe </p>
                </div>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                            <form class="well form-horizontal" action="" method="post" style="background-color:white;" >
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="mot_de_passe">email</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="mot_de_passe">nouveau mot de passe</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="mot_de_passe">confirmer le nouveau mot de passe</label>
                                        <input id="mot_de_passe" name="mot_de_passe" type="password" class="form-control" >  
                                    </div>
                                </div>
